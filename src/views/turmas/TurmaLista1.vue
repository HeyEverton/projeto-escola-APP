<template>
    <b-card>
        <h1 class="mb-3 d-flex justify-content-center">Todas as turmas</h1>
              ...
              <b-input-group>
                <b-input-group-prepend>
                  <b-dropdown text="Pesquisando por" variant="outline-primary">
                    <b-dropdown-item ref="nome" id="nome">Nome</b-dropdown-item>
                    <b-dropdown-item ref="turno" id="turno">Turno</b-dropdown-item>
                  </b-dropdown>
                </b-input-group-prepend>

                <b-form-input placeholder="Pesquisa..." v-model="campoPesquisa" />
